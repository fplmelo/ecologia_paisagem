...
::: {.columns}
::: {.column width="50%"}
![Figura: Geometria da biodiversidade (Tamanho x Distância)](figura_tbi_geometria.png)
:::
...
::: {.column width="50%"}
<!-- Espaço para figura: Foto aérea de fragmento isolado em pastagem -->
:::
:::
...
::: {.column width="50%"}
<!-- Espaço para figura: Diagrama de bisseção e encolhimento de manchas -->
:::
:::
...
::: {.column width="50%"}
![Figura: Modelos de desenho de reservas (melhor vs. pior)](figura_reservas.png)
:::
:::
...
::: {.column width="50%"}
<!-- Espaço para figura: Screenshot de software SIG calculando métricas -->
:::
:::

## O Limiar de 30% de Cobertura
...
::: {.column width="50%"}
<!-- Espaço para figura: Gráfico de limiar de extinção vs. % habitat -->
:::
:::
...
::: {.columns}
::: {.column width="50%"}
![Figura: Matriz permeável (agrofloresta) vs. Hostil (pasto)](figura_matriz.png)
:::
...
::: {.columns}
::: {.column width="50%"}
*   **Estrutural:** Disposição física e proximidade entre os fragmentos.
*   **Funcional:** Capacidade real do organismo se mover pelo mosaico.
*   A conectividade depende da interação espécie-paisagem.
:::

::: {.column width="50%"}
<!-- Espaço para figura: Esquema de stepping stones facilitando fluxo -->
:::
:::

## Escala de Percepção Biológica

::: {.columns}
::: {.column width="50%"}
*   A paisagem não é definida por critérios humanos, mas pelo organismo.
*   Gafanhotos percebem manchas em metros; onças, em quilômetros.
*   O manejo deve considerar a "lente" da espécie de interesse.
:::

::: {.column width="50%"}
<!-- Espaço para figura: Ilustração de águia vs. borboleta (escala de visão) -->
:::
:::

## Contexto Regional: Mata Atlântica

::: {.columns}
::: {.column width="50%"}
*   Bioma ultra-fragmentado com a maioria dos fragmentos < 50 ha.
*   Aplicação da TBI para identificar áreas prioritárias para conexão.
*   Uso de corredores ecológicos para mitigar o isolamento severo.
:::

::: {.column width="50%"}
![Figura: Mapa de fragmentação da Mata Atlântica brasileira](mapa_ma.png)
:::
:::
...
::: {.column width="50%"}
<!-- Espaço para figura: Diagrama de penetração de luz e vento em bordas -->
:::
:::
...
::: {.columns}
::: {.column width="50%"}
![Figura: Distribuição de remanescentes em fazendas particulares](figura_fazendas.png)
:::
...
::: {.column width="50%"}
<!-- Espaço para figura: Diagrama de dinâmica fonte-sumidouro -->
:::
:::
